  ...
  <div class="page">
    <div class="card">
        ...
        <form @submit.prevent ="handleSubmit">
            <input v-if="mode === 'register'" v-model="form.username" type ="text" placeholder ="Username" required/>
            <input v-model="form.password" type="password" placeholder ="Password" required />
            <input v-if="mode === 'register'" v-model="form.form.comfirmPassword" type ="password" placeholder ="Comfirm Password" required/>
